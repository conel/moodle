<?php
	...
	//print "did: $did<br>";
	//print "filter_category: $filter_category<br>";
            ...
            <tr>
                ...
                <?php
                    ...
                    if ($directorates = $DB->get_records_sql_menu($query)) {
                        ...
                        echo html_writer::select($directorates, 'did', $filter_category, 'choose');
                        echo '</p>';
                    }
                    ...
                    if ($schools = $DB->get_records_sql_menu($query)) {
                        ...
                        echo html_writer::select($schools, 'sid', $filter_category, 'choose');
                        echo '</p>';
                    }
