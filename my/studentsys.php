...
$header = "$SITE->shortname: ".get_string('myhome')." - Student (Default Blocks)";

// Start setting up the page
$params = array();
$PAGE->set_url('/my/studentsys.php', $params);
...
if ($PAGE->user_allowed_editing()) {
    ...
    $url = new moodle_url("$CFG->wwwroot/my/studentsys.php", $params);
