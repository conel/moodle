...
$PAGE->requires->js('/lib/yui/2.9.0/build/dom/dom.js');
$PAGE->requires->js('/lib/yui/2.9.0/build/event/event-min.js');
$PAGE->requires->js('/lib/yui/2.9.0/build/container/container-min.js');
$PAGE->requires->js('/lib/yui/2.9.0/build/dragdrop/dragdrop-min.js');
$PAGE->requires->js('/lib/yui/2.9.0/build/element/element-min.js');
...
if (has_capability('moodle/grade:edit', $context)) {
    ...
    $buttons = print_single_button('', $options, $string, 'get', '_self', true);
} else {
    $USER->gradeediting[$course->id] = 0;
    $buttons = '';
}
...
//print_object(confirm_sesskey());
//print_object(has_capability('moodle/grade:edit', $context));
